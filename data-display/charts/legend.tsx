...
export function LegendFilter({ options, selected, isHorizontal = false, onHandleToggle, className, keyString = 'name', labelColor, isFilterable }: LegendFilterProps) {
    const handleClick = (value: string) => {
        ...
        onHandleToggle && onHandleToggle(updated);
    };
