...
export const structure: FormSection[] = [{
    fields: [[
        { label: 'Email Address', placeholder: 'user@email', name: 'email', autoComplete: 'email' }
    ], [
        { label: 'Password', placeholder: '', name: 'password', inputType: 'password', autoComplete: 'current-password' }
    ]]
}];
